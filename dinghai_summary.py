...
def main() -> int:
    ...
    final = "unavailable" if not completed_shards else "partial" if missing else "degraded" if degraded or not errors_all.empty else "unavailable" if raw_all.empty else "ready"
    ...
    if args.notify and completed_shards:
